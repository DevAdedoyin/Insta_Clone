...
public class SharePictureTab extends Fragment  implements View.OnClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        imgShare = view.findViewById(R.id.placeholder);
        edtImageDescription = view.findViewById(R.id.imgDescription);
            ...
            case R.id.btnShareImage:
                if (receivedImageBitmap != null){
                    if (edtImageDescription.getText().toString().equals("")){
                        FancyToast.makeText(getContext(), "Error: You must specify an image description", FancyToast.LENGTH_LONG, FancyToast.ERROR, true).show();
                    }else {
    ...
    private void getChosenImage() {
        //FancyToast.makeText(getContext(), "You can now access the images", FancyToast.LENGTH_SHORT, FancyToast.INFO, true).show();
